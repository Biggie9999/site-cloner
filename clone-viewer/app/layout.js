...
export const metadata = {
  title: "Phantom: The money app that'll take you places",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className="bg-white text-[#121212] font-sans antialiased flex flex-col min-h-screen">
        <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            {/* Logo */}
            <div className="flex items-center gap-2">
              <svg fill="none" viewBox="0 0 152 30" className="w-[120px] text-[#121212]">
        ...
        <footer className="bg-gray-50 border-t border-gray-200 py-16 text-gray-600 mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
            <div className="col-span-2 lg:col-span-1">
              <span className="text-black font-bold text-xl block mb-6">phantom</span>
              <p className="text-sm">The money app that'll take you places.</p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="#" className="hover:text-black transition-colors text-sm">About</a>
              <a href="#" className="hover:text-black transition-colors text-sm">Careers</a>
              <a href="#" className="hover:text-black transition-colors text-sm">Blog</a>
            </div>
            <div className="flex flex-col gap-4">
              <span className="text-black font-semibold">Resources</span>
              <a href="#" className="hover:text-black transition-colors text-sm">Help Center</a>
              <a href="#" className="hover:text-black transition-colors text-sm">Developers</a>
              <a href="#" className="hover:text-black transition-colors text-sm">Security</a>
            </div>
          </div>
        </footer>
      </body>
